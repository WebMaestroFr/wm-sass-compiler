...
class WM_Sass
{
	...
	private static function init_variables()
	{
		...
		self::$variables['recorded'] = array_filter( (array) get_option( 'sass_variables' ) );
	...
	public static function init()
	{
		...
		$config = array_merge( $d, array_filter( (array) apply_filters( 'sass_configuration', $d ) ) );
		...
		add_action( 'wp_print_scripts', array( __CLASS__, 'print_styles' ) );
		add_action( 'sass_compiler_settings_updated', array( __CLASS__, 'settings_updated' ) );
		// add_action( 'customize_register', array( __CLASS__, 'customize_register' ) );
		// add_action( 'customize_save', array( __CLASS__, 'customize_save' ) );
	...
	{
		$recorded = self::get_variables( 'recorded' );
		foreach ( array_keys( self::get_variables( 'control' ) ) as $name ) {
			$recorded[$name] = get_theme_mod( $name );
		}
		update_option( 'sass_variables', array_filter( $recorded ) );
		self::init_variables();
		if ( is_file( self::$href ) ) {
			unlink( self::$href );
		}
